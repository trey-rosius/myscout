...
class PuntingScreen extends StatefulWidget {
  PuntingScreen({this.userId});
  final String userId;

  @override
  _PuntingScreenState createState() => _PuntingScreenState();
}

class _PuntingScreenState extends State<PuntingScreen> {
  ...
  void handleSubmitInfo()
  {
    ...
    map[Config.punts] = puntsController.text;
