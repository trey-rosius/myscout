  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: StreamBuilder(
          stream: Firestore.instance.collection(Config.schedules).where(Config.scheduleAdmin,isEqualTo: userId).orderBy(Config.scheduleDay,descending: true).snapshots(),
